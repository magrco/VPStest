...
about () {
	...
	echo "  \               V 3.0.1  (31 Jan 2018)                  / "
	echo "  \             Created by hageek                         / "
	echo "  ========================================================= "
	echo ""
	echo "  This script is based on bench.sh by hageek from hageek.com"
	echo ""
}
...
speedtestresults () {
	...
	if hash python 2>$NULL; then
		curl -Lso speedtest-cli https://raw.githubusercontent.com/wwwhageekcom/testvps/master/speedtest.py
