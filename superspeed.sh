...
#
# Copyright (C) 2018 hageek <wiz@hageek.com>
#
...
if  [ ! -e '/tmp/speedtest.py' ]; then
    wget --no-check-certificate -P /tmp https://raw.githubusercontent.com/wwwhageekcom/testvps/master/speedtest.py > /dev/null 2>&1
fi
