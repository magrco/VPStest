...
#
# Copyright (C) 2017 - 2018 hageek <wiz@hageek.com>
#
#
...
about() {
	...
	echo " \                   Created by hageek                  / "
	echo " ========================================================= "
	echo ""
	echo " Intro: https://blog.hageek.com"
	echo " Copyright (C) 2018 hageek wiz@hageek.com"
	echo ""
}
...
benchinit() {
	...
	if  [ ! -e 'speedtest.py' ]; then
		...
		wget --no-check-certificate https://raw.githubusercontent.com/wwwhageekcom/testvps/master/speedtest.py > /dev/null 2>&1
	fi
	...
	if  [ ! -e 'tools.py' ]; then
		...
		wget --no-check-certificate https://raw.githubusercontent.com/wwwhageekcom/testvps/master/tools.py > /dev/null 2>&1
	fi
	chmod a+rx tools.py
	...
	if  [ ! -e 'fast_com.py' ]; then
		...
		wget --no-check-certificate https://raw.githubusercontent.com/wwwhageekcom/testvps/master/fast_com.py > /dev/null 2>&1
		wget --no-check-certificate https://raw.githubusercontent.com/wwwhageekcom/testvps/master/fast_com_example_usage.py > /dev/null 2>&1
	fi
